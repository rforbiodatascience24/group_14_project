...
![skriv noget](results/06_key_plot_1.png){fig-align="center" width="60%"}
:::
:::
...
::: {style="font-size:70%;"}
Scatter plot of correlation between gene expresseion for KO and baseline genes for OVCAR3\
![skriv noget](results/06_key_plot_2.png){fig-align="center" width="100%"}
:::
:::
...
![skriv noget](results/06_key_plot_3.png){fig-align="center" width="100%"}
:::
:::
:::
:::
