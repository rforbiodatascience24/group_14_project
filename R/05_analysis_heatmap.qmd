...
A heatmap of 70 randomly sampled genes is created. The heatmap shows the 70 genes colored by log2FC for each cell line. Red color indicates upregulated genes and blue indicates downregulated genes.

```{r}
#70 are sampled rondomly
data |>
  sample_n(70) |> 
  pivot_longer(
