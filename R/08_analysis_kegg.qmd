...
Only one pathway was significantly up-regulated for the OVCAR3 cell
line.
...
Several pathways were enriched when looking at the DEGs that were
down-regulated in the OVCAR3 KO cell line. The top 3 pathways are all
related to cancer, but also cellular senescence is seen in the plot.
...
The KEGG analysis indicate that the majority of the regulation can only
be seen in the OVCAR3 cell line.
