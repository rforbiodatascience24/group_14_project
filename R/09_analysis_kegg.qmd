...
### Kegg enrichment for all upregulated genes in OVCAR3
...
kegg_results <- as_tibble(kegg_analysis_OVCAR3_upregulated)
...
### Kegg enrichment for all downregulated genes in OVCAR3
...
kegg_results <- as_tibble(kegg_analysis_OVCAR3_downregulated)
