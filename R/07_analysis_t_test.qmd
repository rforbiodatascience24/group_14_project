...
Pivot data that contains MOCK or KO for both cell lines to a long format
...
The p-value is 5.84e-17 for SKOV. This means that there are a strong statistical significant difference between the values of KO vs MOCK in this cell line.
