...
The log2 fold change (log2FC) is calculated for each of the cell lines (OVCAR3 and SKOV3) and added as the two columns log2FC_OVCAR3 and log2FC_SKOV3 to assess the affect of KO.
...
Two new columns are added (DEG_OVCAR3 and DEG_SKOV3) to the tibble that identifies whether each gene is up- or down-regulated in each cell line based on the log2FC.
